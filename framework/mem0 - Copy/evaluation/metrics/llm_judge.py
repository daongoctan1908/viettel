...
from api_clients import create_chat_client, get_judge_model
from mem0.memory.utils import extract_json

load_dotenv(EVAL_DIR.parent / ".env", override=True)

chat_client, _chat_client_config = create_chat_client()
